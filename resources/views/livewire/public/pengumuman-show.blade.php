    <div>
        ...
        <div class="relative h-[400px] md:h-[500px] bg-gray-900 w-full overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 w-full p-6 md:p-12 max-w-7xl mx-auto z-10">
                ...
                <nav class="flex text-sm text-gray-300 mb-6 space-x-2 font-medium">
                    ...
                    <span>/</span>
                    <a href="{{ route('pengumuman.index') }}" class="hover:text-unmaris-yellow transition">Kabar
                        Kampus</a>
                    <span>/</span>
        ...
        {{-- 2. MAIN CONTENT --}}
        <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12 -mt-20 relative z-20">
            ...
            <div class="lg:col-span-8 bg-white rounded-2xl shadow-xl p-8 md:p-12">
                ...
                <div class="mt-12 pt-8 border-t border-gray-100">
                    <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4">Bagikan Informasi Ini</h4>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 sticky top-28">
                    ...
                    <div class="space-y-6">
                        @foreach ($terkaits as $item)
                            <a href="{{ route('pengumuman.show', $item->slug) }}" class="group flex gap-4 items-start">
                                {{-- Thumbnail Mini --}}

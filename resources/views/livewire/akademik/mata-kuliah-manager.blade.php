<div>
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <input
            ...
            placeholder="Cari Kode MK atau Nama..."
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($mataKuliahs as $mk)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $mk->nama_mk }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $mk->programStudi?->nama_prodi ?? '-' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $mk->sks }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $mk->semester }}</td>
            ...
            <form wire:submit="save">
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="kode_mk" id="kode_mk" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="nama_mk" id="nama_mk" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" wire:model="sks" id="sks" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            @error('sks') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label for="semester" class="block text-sm font-medium text-gray-700">Semester</label>
                            <input type="number" wire:model="semester" id="semester" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">

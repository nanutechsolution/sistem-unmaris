    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Dosen</th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Identitas
                    </th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Homebase
                    </th>
                    <th scope="col"
        ...
        <div class="relative w-full max-w-4xl p-6 bg-white rounded-xl shadow-2xl max-h-[90vh] overflow-y-auto"
            ...
            <form wire:submit="save">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-5">
                        <h4 class="text-sm font-bold text-gray-500 uppercase tracking-wider border-b pb-1">Data Utama
                        </h4>
                    ...
                    <div class="space-y-5">
                        <h4 class="text-sm font-bold text-gray-500 uppercase tracking-wider border-b pb-1">Kepegawaian
                            & Kontak</h4>

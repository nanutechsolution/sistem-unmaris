        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4">
                    <div class="w-12 h-12 bg-unmaris-yellow/20 text-unmaris-blue rounded-full flex items-center justify-center text-xl">
                        <i class="{{ $stat['icon'] }}"></i>
                    </div>
                    <div>
                        <span class="block text-2xl font-extrabold text-gray-900 leading-none">{{ $stat['value'] }}</span>
                        <span class="text-xs text-gray-500 uppercase tracking-widest mt-1">{{ $stat['label'] }}</span>
                    </div>
                </div>
                @endforeach
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <a href="{{ $col['link'] }}" class="group block bg-gray-50 p-6 rounded-2xl border border-gray-200 hover:shadow-xl transition duration-300 hover:border-unmaris-blue/50">
                    <div class="flex items-start gap-5">
                        <div class="w-16 h-16 rounded-xl bg-unmaris-blue text-white flex items-center justify-center text-3xl flex-shrink-0 shadow-lg group-hover:bg-unmaris-yellow group-hover:text-unmaris-blue transition">
                            <i class="{{ $col['icon'] }}"></i>
                        </div>
                        <div class="flex-grow">
                            <h3 class="text-xl font-bold text-gray-800 mb-2 group-hover:text-unmaris-blue transition">{{ $col['title'] }}</h3>
                            <p class="text-gray-600 text-sm mb-3">{{ $col['description'] }}</p>
                            <span class="text-xs font-bold text-unmaris-blue uppercase tracking-wider bg-blue-50 px-2 py-1 rounded-full border border-blue-100">
                                {{ $col['stats'] }}
                            </span>
                        </div>
                        <i class="fas fa-arrow-right text-gray-400 mt-2 transition-transform group-hover:translate-x-1"></i>
                    </div>
                </a>
                @endforeach
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-3 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="text-gray-600 hover:text-unmaris-blue">Pengajuan Surat Bebas Pustaka</a></li>
                    <li><a href="#" class="text-gray-600 hover:text-unmaris-blue">Panduan Akses Jurnal</a></li>
                    <li><a href="#" class="text-gray-600 hover:text-unmaris-blue">Pusat Bantuan Repository</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm">Gedung Rektorat Lt. 2, Kampus Utama UNMARIS, Waingapu, Sumba Timur.</p>
            </div>

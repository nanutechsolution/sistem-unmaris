<x-layouts.public title="LPM — Penjaminan Mutu">
    <section class="bg-unmaris-blue text-white pt-48 pb-24 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
            {{-- Badge Kecil --}}
            <span
                class="inline-block py-1 px-3 rounded-full bg-unmaris-yellow/20 text-unmaris-yellow text-xs font-bold tracking-widest uppercase mb-4 border border-unmaris-yellow/30">
                Quality Assurance
            </span>
            ...
            <p class="text-blue-100 font-medium max-w-3xl mx-auto text-lg md:text-xl leading-relaxed">
                Mengawal dan menjamin kualitas akademik dan non-akademik di <span
                    class="text-unmaris-yellow font-bold">Universitas Stella Maris Sumba</span> menuju standar unggul.
            </p>
        </div>
    </section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 pb-16 grid lg:grid-cols-3 gap-10 -mt-12 relative z-20">
        ...
        <aside class="lg:col-span-1 space-y-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-xl border-t-4 border-unmaris-yellow">
                <h3
                    class="text-xl font-extrabold text-unmaris-blue mb-5 border-b border-gray-100 pb-3 flex items-center">
                    <i class="fas fa-bullhorn text-unmaris-yellow mr-3"></i> Pengumuman Terbaru
                </h3>

                <div class="space-y-4">
                    @forelse($announcements as $a)
                        <a href="{{ route('public.lpm.announcement.show', $a->slug) }}"
                            class="block group p-3 -mx-3 rounded-lg transition duration-200 hover:bg-blue-50 border-l-4 border-transparent hover:border-unmaris-blue">
                            <p
                                class="font-bold text-gray-800 group-hover:text-unmaris-blue transition text-sm leading-snug">
                                {{ $a->title }}
                            </p>
            ...
            <div class="bg-unmaris-blue p-6 rounded-2xl shadow-lg text-white relative overflow-hidden">
                ...
                <p class="text-blue-100 text-sm leading-relaxed relative z-10 mb-4">
                    LPM berkomitmen mewujudkan budaya mutu melalui siklus penetapan, pelaksanaan, evaluasi,
                    pengendalian, dan peningkatan (PPEPP) secara berkelanjutan.
                </p>
                <div class="relative z-10">
                    <a href="{{ route('public.lpm.profile') }}"
                        class="inline-block px-4 py-2 rounded-lg bg-unmaris-yellow text-unmaris-blue text-xs font-bold hover:bg-white transition">
                        Lihat Visi & Misi
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div class="flex items-center justify-between mb-8 border-b-2 border-gray-100 pb-4">
                    ...
                    <div class="hidden sm:block">
                        <span
                            class="bg-blue-50 text-unmaris-blue text-xs font-bold px-3 py-1 rounded-full border border-blue-100">
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    @forelse($documents as $doc)
                        <a href="{{ route('public.lpm.document', $doc->slug) }}"
                            class="flex flex-col h-full border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg hover:border-unmaris-blue/30 transition duration-300 group bg-white">
                            <div class="p-5 flex-1 flex flex-col">
                                {{-- Header Kartu: Kategori & Ikon PDF --}}
                                <div class="flex justify-between items-start mb-3">
                                    <span
                                        class="inline-block px-2 py-1 text-[10px] font-bold uppercase rounded-md tracking-wide
                                    ...
                                    <i
                                        class="fas fa-file-pdf text-gray-300 group-hover:text-red-500 transition text-lg"></i>
                                </div>

                                {{-- Judul --}}
                                <h3
                                    class="text-lg font-bold text-gray-800 mb-3 group-hover:text-unmaris-blue transition line-clamp-2">
                                    {{ $doc->title }}
                                </h3>
                            ...
                            <div
                                class="bg-gray-50 px-5 py-2 border-t border-gray-100 text-xs font-bold text-gray-500 group-hover:bg-unmaris-blue group-hover:text-white transition flex justify-between items-center">

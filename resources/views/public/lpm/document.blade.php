<x-layouts.public :title="$doc->title">
    ...
    {{-- 1. HERO SECTION --}}
    <section class="bg-unmaris-blue text-white pt-48 pb-12 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-4 gap-10">
        ...
        <aside class="lg:col-span-1">
            ...
            <div
                class="bg-white p-6 rounded-2xl shadow-xl border-t-4 border-unmaris-yellow lg:sticky lg:top-32 z-20 relative lg:-mt-20">
                ...
                <ul class="space-y-3 text-sm text-gray-600 border-b border-gray-100 pb-4 mb-4">
                    ...
                    <li class="flex flex-col">
                        ...
                        <span class="mt-1">
                            <span
                                class="inline-block px-2 py-1 text-xs font-bold uppercase rounded bg-unmaris-blue/10 text-unmaris-blue">
                                {{ $doc->category }}
                            </span>
                        </span>
                    </li>
                    <li class="flex flex-col">
                        ...
                        <span
                            class="font-semibold text-gray-700">{{ optional($doc->published_at)->format('d F Y') }}</span>
                    </li>
                </ul>
        ...
        <div class="lg:col-span-3">
            <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div class="flex items-center mb-6 border-b border-gray-100 pb-4">
                    <div
                        class="w-10 h-10 rounded-full bg-unmaris-blue/10 flex items-center justify-center text-unmaris-blue mr-3">
